...
# loadkeys [keymap]
# curl https://raw.githubusercontent.com/klafuenf/alis/master/download.sh | bash, or with URL shortener curl -sL https://bit.ly/2F3CATp | bash
...
```
$ curl https://raw.githubusercontent.com/klafuenf/alis/master/download-packer.sh | bash
